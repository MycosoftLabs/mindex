...
class ETLSettings(BaseSettings):
    ...
    inat_domain_mode: str = Field(
        default="fungi",
        description="iNaturalist root filter: 'fungi' for fungi-only (default); 'all' for all life (taxon_id=1).",
    )
    ...
    gbif_domain_mode: str = Field(
        default="fungi",
        description="GBIF root filter: 'fungi' for fungi-only (default), 'all' for all life.",
    )
